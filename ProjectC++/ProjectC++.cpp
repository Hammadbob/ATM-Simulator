...
#include <windows.h>
#include <conio.h>// for capturing character
#include <string.h> //
#include <time.h> //These h files are used integrating local time of Comp
#include <ctime>  //As mention Above
using namespace std;
char load = 219;
...
class Double_Pointer_Linked  //Implementation of Node's
{
private:
	Node* head, * tail;
	...
	void Search_Account(string ID1, string no)
	{
		...
		while (ptr != NULL)
		{
			if (ptr->NAME == ID1 || ptr->CNIC_c == no)
			{
				...
				cout << "\n";
				cout << "\t\t\t\t\t" << load << "                              " << load << endl;
				cout << "\t\t\t\t\t" << load << "         ATM Simulator        " << load << endl;
				cout << "\t\t\t\t\t" << load << "                              " << load << endl;
				cout << "\t\t\t\t\t";
				for (int j = 0; j <= 31; j++)
					cout << load;
...
public:
	int main_manu()
	{
		...
		do
		{
			...
			cout << "\t\t\t\t\t" << load << "       ~~~~~~~~~~~~~~~~~~~      " << load << endl;
			cout << "\t\t\t\t\t" << load << "                                " << load << endl;
			cout << "\t\t\t\t\t" << load << "    [1]  :  Login User Account  " << load << endl;
...
public:
	...
	void group_introduction()
	{
		...
		cout << "\t\t\t\t\t" << load << "      ~~~~~~~~~~~~~~~~~~~     " << load << endl;
		cout << "\t\t\t\t\t" << load << "                              " << load << endl;
		cout << "\t\t\t\t\t" << load << "       Roshaan Ahmad 070      " << load << endl;
		cout << "\t\t\t\t\t" << load << "       Sajid ali Syed 436     " << load << endl;
		cout << "\t\t\t\t\t" << load << "       Hammad Javed 437       " << load << endl;
		cout << "\t\t\t\t\t" << load << "                              " << load << endl;
		cout << "\t\t\t\t\t" << load << "                              " << load << endl;
		cout << "\t\t\t\t\t";
		for (int i = 0; i <= 31; i++)
...
int main()
{
	...
	system("cls");
	string wlm = "WELCOME TO ATM Simulator";
